...
public class OldFitnessSyncActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // FitnessSyncService.scheduleFitnessSync(OldFitnessSyncActivity.this);
        ...
        setContentView(R.layout.activity_old_fitness_sync);
