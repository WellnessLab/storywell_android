...
public class PlacesByZipCodes {
    ...
    public PlacesByZipCodes() {
        ...
        zipNeighborhoodMap.put("02133",	"Downtown Boston");
        ...
        zipNeighborhoodMap.put("02139",	"Cambridge");
        zipNeighborhoodMap.put("02140",	"Cambridge");
        zipNeighborhoodMap.put("02141",	"Cambridge");
        zipNeighborhoodMap.put("02142",	"Cambridge");
        zipNeighborhoodMap.put("02143",	"Somerville");
        zipNeighborhoodMap.put("02144",	"Somerville");
        zipNeighborhoodMap.put("02145",	"Somerville");
        zipNeighborhoodMap.put("02163",	"Cambridge");
        zipNeighborhoodMap.put("02196",	"Downtown Boston");
        zipNeighborhoodMap.put("02199",	"Prudential");
        zipNeighborhoodMap.put("02201",	"Downtown Boston");
        zipNeighborhoodMap.put("02205",	"Downtown Boston");
        zipNeighborhoodMap.put("02210",	"South Boston");
        zipNeighborhoodMap.put("02215",	"Kenmore");
        zipNeighborhoodMap.put("02216",	"Downtown Boston");
        zipNeighborhoodMap.put("02228",	"East Boston");
        zipNeighborhoodMap.put("02238",	"Cambridge");
